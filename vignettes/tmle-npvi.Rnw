...
The package includes real data, namely expression, DNA copy number, and DNA methylation data of 30 genes for 463 breast cancer samples from TCGA \cite{TCGA12}.  
